...
var philipsHueLightNumber = 4;  //The number of the light in the lights responses, this is shown as '"<number>" : {'
var philipsHueLightID = "00:17:88:01:00:cd:33:2e-0b";  //The value of the uniqueID of the light

var accessoryName = "Bedroom"; //The name of the light
var model = "LST001"; //The model id of the light, this is important to properly support hue lux lights
